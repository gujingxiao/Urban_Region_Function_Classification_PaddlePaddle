...
from cnn_combine.resnet50_dpn26.train_resnet50_dpn26 import MultiModel
...
def infer():
    ...
    infer_reader = paddle.batch(
        reader=infer_data_reader(config['root_path']+'test.txt', infer_mapper, config['root_path']+"npy/test_visit/"), batch_size=batch_size)
